...
# This template runs a simple "Cisco SPL" web server in Auto Scaling Group (ASG) with an Elastic Load Balancer
...
provider "aws" {
          access_key = "AKIA4HUL3GBVEFHV55N7"
          secret_key = "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"
	  region = "us-east-2"
}
